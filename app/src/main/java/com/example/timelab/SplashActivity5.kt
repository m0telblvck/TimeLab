...
class SplashActivity5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_splash5) // Замените на имя вашего XML-файла
    ...
    private fun startSplashActivity6() {
        val intent = Intent(this, SplashActivity6::class.java)
