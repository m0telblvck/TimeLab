...
class SplashActivity6 : AppCompatActivity() {
    private lateinit var progressBar: ProgressBar
    private var currentStep: Int = 5

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_splash6) // Замените на имя вашего XML-файла
    ...
    private fun startSplashActivity7() {
        val intent = Intent(this, SplashActivity7::class.java)
